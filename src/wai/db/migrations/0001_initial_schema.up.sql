...
--   - Upstream API keys: AES-256-GCM encrypted via WAI_ENCRYPTION_KEY
--
-- Entity Hierarchy:
--
--   users
...
-- Upstream API keys are encrypted at rest via WAI_ENCRYPTION_KEY.
...
-- Global aliases are defined in wai.yaml, not in this table.
...
-- client_secret_enc is AES-256-GCM encrypted via WAI_ENCRYPTION_KEY.
